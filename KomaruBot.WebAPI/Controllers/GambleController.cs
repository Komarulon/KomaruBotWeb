...
namespace KomaruBot.WebAPI.Controllers
{
    ...
    public class GambleController : Controller
    {
        ...
        public ActionResult Get()
        {
            try
            {
                ...
                var settings = this.userHelper.EnsureDefaultGambleSettings(userInfo.GetUserID());
