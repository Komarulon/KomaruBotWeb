...
namespace KomaruBot.WebAPI.Controllers
{
    ...
    public class HypeController : Controller
    {
        ...
        private ILogger<HypeController> _logger { get; set; }
        ...
        public ActionResult Get()
        {
            try
            {
                ...
                var hype = this.userHelper.EnsureDefaultHypeSettings(userInfo.GetUserID());
